...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-yt-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div style="width: 100%; height: 100%; fill: currentcolor">
                    <svg class="external-icon" viewBox="0 0 90 20" focusable="false" style="
                pointer-events: none;
                display: block;
                width: 100%;
                height: 100%;
            ...
            <li class="nav-item {{ request()->is($artist . '/reciept') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('artist.reciept', ['artist' => $artist]) }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Reciept</span>
                </a>
            </li>
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column" style="background-color: #1f1f1f">
                <!-- Main Content -->
                <div id="content">
                    <!-- Topbar -->
