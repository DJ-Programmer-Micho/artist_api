                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-4">
                        <div class="progress-bar bg-danger" role="progressbar"
                            style="width: {{ ($item / $totalQuantities) * 100 }}% " aria-valuenow="{{ $item }}"
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-4">
                        <div class="progress-bar bg-danger" role="progressbar"
                            style="width: {{ ($item / intval($earningsSum)) * 100 }}%" aria-valuenow="{{ $item }}"
                            aria-valuemin="0" aria-valuemax="3"></div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="col-lg-6 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="progress mb-4">
                        <div class="progress-bar bg-danger" role="progressbar"
                            style="width: {{ ($item / intval($totalQuantities)) * 100 }}%" aria-valuenow="{{ $item }}"
                            aria-valuemin="0" aria-valuemax="3"></div>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <div aria-level="1" class="logo-button-container _ngcontent-awn-AWSM-2" role="heading">
                            <div buttondecorator="" class="app-bar-logo _ngcontent-awn-AWSM-2 glif-lockup ads-logo en"
                                ...
                                <div class="lockup-logo _ngcontent-awn-AWSM-2" role="presentation">
                                    <svg class="lockup-ads-logo _ngcontent-awn-AWSM-2"
                                        enable-background="new 0 0 192 192" height="192" viewBox="0 0 192 192"
                                        width="192" xmlns="http://www.w3.org/2000/svg">
                                        <g class="_ngcontent-awn-AWSM-2">
                                            <rect fill="none" height="192" width="192" class="_ngcontent-awn-AWSM-2">
                                            </rect>
                                            <g class="_ngcontent-awn-AWSM-2">
                                                <rect fill="#FBBC04" height="58.67"
                                                    transform="matrix(0.5 -0.866 0.866 0.5 -46.2127 103.666)"
                                                    width="117.33" x="8" y="62.52" class="_ngcontent-awn-AWSM-2"></rect>
                                                <path
                    ...
                    <a target="_blank" class="text-danger" href="https://ads.google.com/intl/en_IQ/home/">Browse
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <small>need Help
                        <a class="text-danger" href="https://support.google.com/youtube/answer/1709858?hl=en">Steps to
                            getting paid</a></small>
                </div>
            </div>
        </div>
    </div>
