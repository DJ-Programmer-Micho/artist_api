...
<div class="container-fluid">
    ...
    <!-- Content Row -->
    <div class="row">
        {{-- <h3 class="text-success">PROFIT</h3> --}}
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gary-200">
                                ${{$static['met_profit'] + $static['profit_tax']}}
                            </div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
            ...
            <table class="table table-bordered table-dark ">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle text-center">Artist Name</th>
                        <th class="align-middle text-center">Profit</th>
                        <th class="align-middle text-center">Astist Profit</th>
                        <th class="align-middle text-center">MET Profit</th>
                        <th class="align-middle text-center">Tax no.</th>
                        <th class="align-middle text-center">Tax</th>
                        <th class="align-middle text-center">Profit Tax</th>
                ...
                <tbody>
                    @forelse ($static_table as $index => $st)
                        <tr>
                    ...
                    @empty
                        <tr>
                            <td><p>Internet Err or Google Sheet Err</p></td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
