...
<div class="container-fluid">      
    <form action="{{route('owner.expire.add')}}" method="POST">
        @csrf
        <div class="d-flex justify-content-between mb-3">
            <div>
                <h3 class="text-white">ADD SONG</h3>
            </div>
            <div>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="p-4 border mb-3" style="background-color: #323334; border-radius: 25px; border-color: #aaa; ">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            <label class="text-white">TITLE:</label>
                            <input type="text" name="title" class="form-control bg-dark text-white" placeholder="Song Name">
                        </div>
                        <div class="form-group col-md-12">
                            <label class="text-white">RELEASE:</label>
                            <input type="date" name="release" class="form-control bg-dark text-white" placeholder="Release Date">
                        </div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="image" class="form-control bg-dark text-white" placeholder="Cr5kKd----">
                            <small class="text-info">Take It From Music Youtube</small>
                        </div>
                    </div>
                </div>
            </div>
