...
class ArtistController extends Controller
{
    public function test(){
        ...
        $Sheet_id =  $userData->profile->s_id;
        ...
        $apiUrl = 'https://www.googleapis.com/youtube/v3/channels?part=snippet,contentDetails,statistics&id=' . $channel_id . '&key=' . $apiKey;
    ...
    ['channelName' =>  $channelName, 'subscribersCount' => $subscribersCount, 'viewCount' => $viewCount, 'uploadsCount'=>$uploadsCount, 'hiddenSubscriberCount'=>$hiddenSubscriberCount, 'earningsSum' => $earningsSum]);
    }
}
